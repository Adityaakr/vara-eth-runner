...
const must = ['Live execution telemetry', 'Median pre-confirm', 'Controls', 'Transactions', 'Ethereum settlement', 'Comparison and fault injection', `event sequence ${snap.preconf.seq}`];
