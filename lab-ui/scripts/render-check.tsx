...
const must = ['Pre-confirmation telemetry', 'Median pre-confirm', 'pre-confirmed in the last 3 min', 'Transactions', 'Ethereum settlement', 'Comparison and fault injection', `event sequence ${snap.preconf.seq}`];
